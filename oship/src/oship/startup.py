...
def interactive_debug_prompt(zope_conf='/home/tim/oshipenv3/oship/oship/etc/zope.conf'):
...
def zdaemon_controller(zdaemon_conf='/home/tim/oshipenv3/oship/oship/etc/zdaemon.conf'):
