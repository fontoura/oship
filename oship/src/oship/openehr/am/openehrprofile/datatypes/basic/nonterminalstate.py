...
from oship.openehr.am.openehrprofile.datatypes.basic.state import State
from oship.openehr.am.openehrprofile.datatypes.basic.interfaces.nonterminalstate import INonTerminalState
