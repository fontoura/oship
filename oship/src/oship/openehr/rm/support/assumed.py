...
Implementation of primitive and other data types assumed by openEHR support_im.pdf
...
class OrderedNumeric(Ordered, Numeric):
    u"""
...
class Iso8601Date(Ordered,TimeDefinitions):
    u"""
...
class Iso8601Time(Ordered,TimeDefinitions):
    u"""
    ...
    def __init__(self,hr,mn,sc,mc,tz):
        self.t=time(hr,mn,sc,mc,tz)
    ...
    def hasFractionalSecond():
        ...
        return self.t.microsecond != None        
        
    def timezone():
        u"""Time zone; may be Void."""
        
        return self.t.tzinfo
...
class Iso8601DateTime(Ordered,TimeDefinitions):
    u"""
    ...
    def __init__(self,y,m,d,hr,mn,sc,mc,tz):
        self.dt=(y,m,d,hr,mn,sc,mc,tz)
...
class Iso8601Duration(Ordered,TimeDefinitions):
    u"""
