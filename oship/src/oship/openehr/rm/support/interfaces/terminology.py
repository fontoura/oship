...
Defines the interfaces for the terminology package in support_im.pdf Rev. 1.6.0
...
class ITerminologyAccess(IField):
    ...
    id = TextLine(
        title=u'ID',
        description=u'Identification of this Terminology',
        required = True,
        )
...
class ICodeSetAccess(IField):
    ...
    id = TextLine(
        title=u'ID',
        description=u'External identifier of this Code Set',
        required = True,
        )
...
class IOpenehrTerminologyGroupIndentifiers(IField):
    u"""
...
class IOpenehrCodeSetIdentifiers(IField):
