...
__revision__ = "$Id: setup.py 335 2008-01-13 01:50:50Z Franz $"
...
PYCLIPS_MAJOR = 1
PYCLIPS_MINOR = 0
PYCLIPS_PATCHLEVEL = 6
PYCLIPS_INCREMENTAL = 335
...
#  on the class constructor defined below in order to build values to
#  pass to the CLIPS engine
# check Python version, and issue a n exception
...
from _clips_wrap import Nil, Integer, Float, String, Symbol, InstanceName, \\
                        ...
                        _setStockClasses, AROUND, BEFORE, PRIMARY, AFTER
