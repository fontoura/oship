...
from openehr.rm.support.identification.uuid import Uuid
from openehr.rm.support.identification.internetid import InternetId
from openehr.rm.support.identification.isooid import IsoOid
