...
from oship.openehr.rm.datatypes.timespecification.interfaces.dvperiodictimespecification import IDvPeriodicTimeSpecification
from oship.openehr.rm.datatypes.timespecification.dvtimespecification import DvTimeSpecification
